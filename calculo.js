...
document.getElementById("classeAContador").textContent = estudantesClasseA.length; idade = 14 & idade ; 15


document.getElementById("alerta").textContent = "Você não pode competir"
return;
